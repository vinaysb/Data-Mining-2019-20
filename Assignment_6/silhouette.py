...
def silhouette_method(name, X, prop1, prop2):
    ...
    for n_clusters in range_n_clusters:
        ...
        ax2.set_xlabel("Feature space for the 1st feature, num_years_smoke")
        ax2.set_ylabel("Feature space for the 2nd feature, Cholesterol")
